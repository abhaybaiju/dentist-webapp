  ...
  return(
    <Grid container justify="center" alignItems="center">
      <Grid item lg={10} md={10} sm={10} xs={10} style={{marginTop:'5%'}}>
        <h1 style={{color:'#3f3d56', textAlign:'center'}}>Privacy Policy</h1>
      </Grid>
...
<h3 style={{color:'#3f3d56'}}>SECTION 5 - THIRD-PARTY SERVICES</h3><br/><br/>
...
<h3 style={{color:'#3f3d56'}}>SECTION 6 - SECURITY</h3><br/><br/>
...
<h3 style={{color:'#3f3d56'}}>SECTION 9 - CHANGES TO THIS PRIVACY POLICY</h3><br/><br/>
